...
import cn.json.quicknCore.quickn.utils.Assert;
...
public class MockHttpServletRequest implements HttpServletRequest {
	...
	private final Map<String, HeaderValueHolder> headers = new cn.json.quicknCore.quickn.utils.LinkedCaseInsensitiveMap<HeaderValueHolder>();
