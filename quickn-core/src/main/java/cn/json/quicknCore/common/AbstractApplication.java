...
import cn.json.quicknCore.annotation.Filter;
import cn.json.quicknCore.filter.ActionFilter;
import cn.json.quicknCore.guice.QuickjModule;
import cn.json.quicknCore.hibernate.HibernateTemplate;
import cn.json.quicknCore.plugin.Plugin;
import cn.json.quicknCore.test.mock.QuickjMockModule;
...
public abstract class AbstractApplication implements Application {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cn.json.quicknCore.Application#handle(javax.servlet.http.HttpServletRequest,
...
//			ok=true;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cn.json.quicknCore.Application#init()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cn.json.quicknCore.Application#getModels()
	 */
		...
		if (filter != null && filter.name() != null) {
			...
			for (String filterName : filterNames) {
				...
				try {
					...
					try {
						c = Class.forName("cn.json.quicknCore.filter." + s[0]);
